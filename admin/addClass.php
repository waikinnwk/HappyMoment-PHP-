...
<head>
	...
	function back(){
			document.getElementById("addClass").action = "addClass.php";
...
<div class="formarea">
<?php if(!$summayPage) {?>
	<form action='addClass.php' method='POST' id="addClass">
	<input type="hidden" id="action" name="action" value="addClass"/>
	<h2>Add Class</h2>
	...
	<table>
		...
		<tr>
			...
			<td>
				...
				<input type="button" value="Submit" onclick="formSubmit('addClass')">
				</div>
			</td>
		</tr>		
	</table>
...
<?php }  else {?>
	<form action='insertClass.php' method='POST' id="addClass">
	<input type="hidden" id="action" name="action" value="addClass"/>
	<h2>Add Class</h2>
	<div class="subfieldsset">
	<table>
