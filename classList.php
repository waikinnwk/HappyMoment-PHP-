...
<?php 
if (isset($_GET['groupId']) || isset($_GET['groupId'])) {
	$groupId = "";
	if(isset($_GET['groupId']))
		$groupId = $_GET['groupId'];
	else
		$groupId = $_GET['groupId'];
	$classList = getClassListByGroupId($groupId);
	$groupInfo = getAllCakeClassGroupById($groupId);
...
<div class="notebox">
	<font size="6" face="chaoganghei"><?php echo $groupInfo['name']; ?></font>
	<table border="1">
	<tr>
